...
{
    public class Tag : IDomainEntity, IEqualityComparer<Tag>
    {
        public Tag() { }
        ...
        public string Id { get; set; } = $"{DateTime.Now:yyyyMMddHHmmssffffff}";
        ...
        public virtual IList<Portfolio> Projects { get; set; }
